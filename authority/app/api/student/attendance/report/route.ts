...
/**
 * Zod Schema specific to this Attendance Report API.
 * It validates that subject_id is a numeric string and
  ...
  try {
    ...
    if (!user || user.role !== "STUDENT") {
      return NextResponse.json(
        { success: false, message: "Unauthorized: Access restricted to students" },
    ...
    const { subject_id, month: monthVal, year: yearVal } = validation.data;
    ...
    // 6. Construct Final Response (Aligned with Frontend AttendanceTab.js)
